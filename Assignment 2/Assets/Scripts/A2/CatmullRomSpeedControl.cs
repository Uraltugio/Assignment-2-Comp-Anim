...
public class CatmullRomSpeedControl : MonoBehaviour
{
	...
	[SerializeField]CatmullRom CatmullRom;
	...
	private void Update()
	{
		...
		while (distance > table[currentIndex][currentSample + 1].accumulatedDistance)
		{
			...
			// sample resets when interval advances
			// accumulated distance resets when interval advances
